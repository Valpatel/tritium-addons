...
"""SMS Gateway communication addon API routes."""
...
def create_router(plugin: Any) -> APIRouter:
    router = APIRouter(prefix="/api/comms/sms_gateway", tags=["sms_gateway"])
    ...
    async def test_connection():
        """Test the SMS Gateway connection with a ping message."""
