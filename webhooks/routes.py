...
"""Webhooks communication addon API routes."""
...
def create_router(plugin: Any) -> APIRouter:
    router = APIRouter(prefix="/api/comms/webhooks", tags=["webhooks"])
    ...
    async def test_connection():
        """Test the Webhooks connection with a ping message."""
